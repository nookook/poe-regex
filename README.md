...
_(example: "Monsters reflect 18% of Physical Damage" returns **"!f ph"** and "Monsters reflect 18% of Elemental Damage" returns **"!tal d"**, but choosing both will return **"!rs r"**)._
